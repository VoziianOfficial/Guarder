...
(function () {
    ...
    function populateServicesSlider() {
    ...
    class GuarderServicesSlider {
        ...
        init() {
            ...
            this.root.setAttribute('aria-label', 'Home security service categories slider');
    ...
    function initServicesSliders() {
        document.querySelectorAll('[data-services-slider]').forEach((slider) => {
            new GuarderServicesSlider(slider);
        });
    }

    function initServicesPage() {
        populateServicesSlider();
        initServicesSliders();
